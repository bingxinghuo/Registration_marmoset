...
#init
transform1matrix=workingdir+'/data/stackalign/' + patientnumber + 'N/' + patientnumber + '_N_XForm_matrix.txt'
transform1file=workingdir+'/data/stackalign/' + patientnumber + 'N/' + patientnumber + '_N_XForm.txt'
#crop
transform2matrix=workingdir+'/data/stackalign/' + patientnumber + 'N/' + patientnumber + '_N_XForm_crop_matrix.txt'
#firstalign
transform3matrix = workingdir+'/data/registration/' + patientnumber + '/' + patientnumber + '_STSpipeline_output/transforms/' + patientnumber + '_XForm_firstrotation_matrix.txt' 
#sts
transform4matrix=workingdir+'/data/registration/' + patientnumber + '/' + patientnumber + '_STSpipeline_output/transforms/' + patientnumber + '_XForm_matrix.txt'
transform4file=workingdir+'/data/registration/' + patientnumber + '/' + patientnumber + '_STSpipeline_output/transforms/' + patientnumber + '_XForm.txt'
#finalalign
transform5matrix = workingdir+'/data/registration/' + patientnumber + '/'+ patientnumber + '_STSpipeline_output/transforms/' + patientnumber + '_XForm_finalrotation_matrix.txt' 
...
#    registeredimagelist[i] = sitk.Image(testzero)
    ...
    sitk.WriteImage(outSlice, outdir + 'tf' + '%04d' '.tif'%((mylist_sorted[i][0])))
