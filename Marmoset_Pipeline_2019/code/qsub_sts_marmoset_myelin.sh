...
python ~/code/StackAlignNew/rigidSTSBrainBySliceAndTypeCSHL_marmoset_bnb.py /sonas-hs/mitra/hpc/home/blee/data/stackalign/BNBLists/ ~/data/stackalign/${targetnumber}M/ $targetnumber M 0.0588 $singlestartind $singleendind
