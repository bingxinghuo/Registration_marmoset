...
#python ~/code/StackAlignNew/rigidSTSBrainBySliceAndTypeCSHL_marmoset_bnb.py /sonas-hs/mitra/hpc/home/blee/data/stackalign/BNBLists/ ~/data/stackalign/${targetnumber}N/ $targetnumber N 0.0588 $singlestartind $singleendind
#python ~/Marmoset_Pipeline_2019/code/StackAlignNew/rigidSTSBrainBySliceAndTypeCSHL_marmoset_bnb.py /sonas-hs/mitra/hpc/home/kram/Marmoset_Pipeline_2019/data/stackalign/BNBLists/ ~/Marmoset_Pipeline_2019/data/stackalign/${targetnumber}F_maskimg/ $targetnumber F 0.0588 $singlestartind $singleendind
python ~/scripts/Registration/Marmoset_Pipeline_2019/code/StackAlignNew/rigidSTSBrainBySliceAndTypeCSHL_marmoset_bnb.py /sonas-hs/mitra/hpc/home/blee/data/stackalign/BNBLists/ ~/scripts/Registration/Marmoset_Pipeline_2019/data/stackalign/${targetnumber}F_maskimg/ $targetnumber F 0.0588 $singlestartind $singleendind
#python ~/Marmoset_Pipeline_2019/code/StackAlignNew/rigidSTSBrainBySliceAndTypeCSHL_marmoset_yoshita_bnb.py /sonas-hs/mitra/hpc/home/kram/Marmoset_Pipeline_2019/data/stackalign/BNBLists/ ~/Marmoset_Pipeline_2019/data/stackalign/${targetnumber}Y_maskimg/ $targetnumber Y 0.0588 $singlestartind $singleendind
