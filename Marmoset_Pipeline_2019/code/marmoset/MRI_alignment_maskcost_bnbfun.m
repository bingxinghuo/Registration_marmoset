% sample syntax:
% MRI_alignment_maskcost_bnbfun('M819','/sonas-hs/mitra/hpc/home/blee/data/atlas_images/marmoset/atlas_80_flip_masked_eroded_refined.img',...
% '/sonas-hs/mitra/hpc/home/blee/data/atlas_images/marmoset/mask_80_flip_refined.img',
% '/sonas-hs/mitra/hpc/home/blee/data/atlas_images/marmoset/annotation_80_flip.img',
% '/sonas-hs/mitra/hpc/home/bhuo/scripts/Registration/Marmoset_Pipeline_2019/data/stackalign/',
% '/sonas-hs/mitra/hpc/home/bhuo/scripts/Registration/Marmoset_Pipeline_2019/data/target_images/',
% '/sonas-hs/mitra/hpc/home/bhuo/scripts/Registration/Marmoset_Pipeline_2019/data/registration/',
% '/sonas-hs/mitra/hpc/home/bhuo/scripts/Registration/Marmoset_Pipeline_2019/code/marmoset/')
function MRI_alignment_maskcost_bnbfun(patientnumber,atlasfilename,atlasmaskfilename,annofilename,targetdirectoryprefix,mridirectoryprefix,dataoutputdirectoryname,codedir)
...
% input directories
% targetdirectoryprefix = '/sonas-hs/mitra/hpc/home/kram/Marmoset_Pipeline_2019/data/stackalign/';
...
% mridirectoryprefix = '/sonas-hs/mitra/hpc/home/kram/Marmoset_Pipeline_2019/data/target_images/';
...
% output directories
dataoutputdirectoryname = [dataoutputdirectoryname,'/', patientnumber '/'];
...
system(['python ',codedir,'/rigidAlignMRI_maskcost.py ' mrifilename ' ' paddedtarget.fileprefix '.img ' costmask.fileprefix '.img ' dataoutputdirectoryname patientnumber '_MRI_rigid.img ' transformdirectoryname patientnumber '_MRI_rigidtrans.txt']);
...
for i = 1:nepochs
    ...
    if i < nepochs
        system(['python ',codedir,'/rigidAlignMRI_maskcost_simulations.py ' newMRI.fileprefix '.img ' newtarget.fileprefix '.img ' costmask.fileprefix '.img ' dataoutputdirectoryname 'MRI_iter' num2str(i) '.img ' transformdirectoryname 'MRI_transform_iter' num2str(i) '.txt']);
...
system(['python ',codedir,'/maskMarmosetTargetBySlice.py ' orig_target_STS.fileprefix '.img ' dataoutputdirectoryname patientnumber '_targetmask.img ' dataoutputdirectoryname patientnumber '_targetmasked.img']);
else
system(['python ',codedir,'/maskMarmosetTarget.py ' orig_target_STS.fileprefix '.img ' dataoutputdirectoryname patientnumber '_targetmask.img ' dataoutputdirectoryname patientnumber '_targetmasked.img']);
end

% now do rigid matching after masking
system(['python ',codedir,'/rigidAlignMarmosetAtlas_maskcost.py ' atlasfilename ' ' dataoutputdirectoryname patientnumber '_targetmasked.img ' annofilename ' ' atlasmaskfilename ' ' dataoutputdirectoryname patientnumber '_affine.img ' dataoutputdirectoryname patientnumber '_annotation_affine.img ' dataoutputdirectoryname patientnumber '_atlasmask_affine.img ' dataoutputdirectoryname patientnumber '_globalaffinetrans.txt ' costmask.fileprefix '.img']);
...
if localhist == 1
    ...
    system(['python ',codedir,'/histogramMatchingMarmoset.py ' dataoutputdirectoryname patientnumber '_targetmasked.img ' dataoutputdirectoryname patientnumber '_affine_forhist.img ' dataoutputdirectoryname patientnumber '_affine_lhm.img']);
end
...
% do lddmm
system([codedir,'/mm_lddmm2n_ver03_weightonatlas_evensmallersig.pl 2 ' lhmatlas.fileprefix '.img ' lhmtarget.fileprefix '.img ' costmask.fileprefix '.img 0.2 ' atlasmasksmoothed.fileprefix '.img ' targetmasksmoothed.fileprefix '.img ' costmask.fileprefix '.img 0.03 ' dataoutputdirectoryname lddmmoutputdirectoryname ' 3 0.05 10 0.02 10 0.01 10 1 1 1.0']);
...
system([codedir,'/IMG_apply_lddmm_tform1 ' dataoutputdirectoryname patientnumber '_annotation_affine.img ' dataoutputdirectoryname patientnumber '_lddmm/Hmap000.vtk ' dataoutputdirectoryname patientnumber '_annotation.img 2']);

% apply transform to atlas
system([codedir,'/IMG_apply_lddmm_tform1 ' dataoutputdirectoryname patientnumber '_affine.img ' dataoutputdirectoryname patientnumber '_lddmm/Hmap000.vtk ' dataoutputdirectoryname patientnumber '_defatlas.img 1']);

% apply transform to atlas mask
system([codedir,'/IMG_apply_lddmm_tform1 ' dataoutputdirectoryname patientnumber '_atlasmask_affine.img ' dataoutputdirectoryname patientnumber '_lddmm/Hmap000.vtk ' dataoutputdirectoryname patientnumber '_atlasmasklddmm.img 2']);

% post processing transform files
system(['python ',codedir,'/convertVTK.py ' dataoutputdirectoryname patientnumber '_lddmm/Hmap000.vtk ' dataoutputdirectoryname patientnumber '_lddmm/Kimap000.vtk ' transformdirectoryname 'field_forward.vtk ' transformdirectoryname 'field_reverse.vtk 0.08']);
