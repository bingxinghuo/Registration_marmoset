...
% output directories
dataoutputdirectoryname = ['/sonas-hs/mitra/hpc/home/blee/data/registration/' patientnumber '_nosts/'];
...
targetfilename = [paddedtarget.fileprefix '.img'];
...
system(['python maskMarmosetTargetBySlice.py ' targetfilename ' ' dataoutputdirectoryname patientnumber '_targetmask.img ' dataoutputdirectoryname patientnumber '_targetmasked.img']);
else
system(['python maskMarmosetTarget.py ' targetfilename ' ' dataoutputdirectoryname patientnumber '_targetmask.img ' dataoutputdirectoryname patientnumber '_targetmasked.img']);
end
