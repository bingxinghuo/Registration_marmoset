...
transtransform.SetOffset((float(ymin)*0.04, float(xmin)*0.04))

for i in range(img.GetSize()[1]):
    registeredimagelist[i] = sitk.Resample(img[:,i,:], (ymax-ymin+1,xmax-xmin+1), transtransform, sitk.sitkLinear,(0,0), (0.04,0.04), (1,0,0,1), 0.0)
