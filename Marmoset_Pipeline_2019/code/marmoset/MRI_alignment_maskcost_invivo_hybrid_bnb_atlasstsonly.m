...
%system(['python rigidAlignMarmosetAtlas_maskcost.py ' atlasfilename ' ' orig_target_STS.fileprefix '.img ' annofilename ' ' atlasmaskfilename ' ' dataoutputdirectoryname patientnumber '_affine.img ' dataoutputdirectoryname patientnumber '_annotation_affine.img ' dataoutputdirectoryname patientnumber '_atlasmask_affine.img ' dataoutputdirectoryname patientnumber '_globalaffinetrans.txt ' costmask.fileprefix '.img']);
%
...
% load the last sts transforms
%a_old = readSectionTransform([transformdirectoryname 'iter' num2str(nepochs) '_a.txt'])';
%b_old = readSectionTransform([transformdirectoryname 'iter' num2str(nepochs) '_b.txt'])';
%theta_old = readSectionTransform([transformdirectoryname 'iter' num2str(nepochs) '_theta.txt'])';
[a_old,b_old,theta_old] = composeSectionTransforms(transformdirectoryname,nepochs);
