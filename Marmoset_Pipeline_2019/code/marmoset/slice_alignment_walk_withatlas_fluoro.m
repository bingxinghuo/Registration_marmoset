...
if nargin == 0
    input = '/cis/home/dtward/Documents/sandbox/slice_alignment/scrambled.img';
elseif nargin == 2
    cost = 'MSE';
end
if nargin < 8
...
%    figure(888);clf
%    subplot(1,2,1)
%    imagesc(squeeze(atlas(:,140,:)));axis image
%    subplot(1,2,2)
%    imagesc(squeeze(TI_orig(:,140,:)));axis image
%    drawnow;
