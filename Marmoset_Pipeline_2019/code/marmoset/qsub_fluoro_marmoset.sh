...
python ~/code/marmoset/rigidNisslToFluoro_marmoset_bnb.py ${targetnumber} $singlestartind $singleendind /sonas-hs/mitra/hpc/home/blee/data/stackalign/BNBLists2/
