...
% maybe mask nissl
system(['python /sonas-hs/mitra/hpc/home/kram/Marmoset_Pipeline_2019/code/maskBySlice.py ' nisslfilename ' ' outputdirectoryname '/' patientnumber '_orig_target_STS_mask.img ' outputdirectoryname '/' patientnumber '_orig_target_STS_masked.img']);
...
fluoro.img(find(fluoro.img>27)) = 27;
...
% maybe mask
if strcmp(patientnumber,'M876') || strcmp(patientnumber,'M6328') || strcmp(patientnumber,'M1559')
system(['python /sonas-hs/mitra/hpc/home/kram/Marmoset_Pipeline_2019/code/maskBySlice_input.py ' fluoro.fileprefix '.img ' outputdirectoryname '/' patientnumber '_fluoro_mask.img ' outputdirectoryname '/' patientnumber '_fluoro_masked.img 7.5']);
elseif strcmp(patientnumber,'M852')
system(['python /sonas-hs/mitra/hpc/home/kram/Marmoset_Pipeline_2019/code/maskBySlice_input.py ' fluoro.fileprefix '.img ' outputdirectoryname '/' patientnumber '_fluoro_mask.img ' outputdirectoryname '/' patientnumber '_fluoro_masked.img 6.5']);
elseif strcmp(patientnumber,'M854') || strcmp(patientnumber,'M6328')
system(['python /sonas-hs/mitra/hpc/home/kram/Marmoset_Pipeline_2019/code/maskBySlice_input.py ' fluoro.fileprefix '.img ' outputdirectoryname '/' patientnumber '_fluoro_mask.img ' outputdirectoryname '/' patientnumber '_fluoro_masked.img 8.5']);
else
system(['python /sonas-hs/mitra/hpc/home/kram/Marmoset_Pipeline_2019/code/maskBySlice.py ' fluoro.fileprefix '.img ' outputdirectoryname '/' patientnumber '_fluoro_mask.img ' outputdirectoryname '/' patientnumber '_fluoro_masked.img']);
end


fluoro = avw_img_read([outputdirectoryname '/' patientnumber '_fluoro_masked.img'],0);

fluoropre = avw_img_read([outputdirectoryname '/' patientnumber '_fluoro_pre.img'],0);
for i = 1:size(fluoropre.img,2)
    if length(unique(fluoro.img(:,i,:))) <= 2 && length(unique(fluoropre.img(:,i,:))) > 2
        fluoro.img(:,i,:) = fluoropre.img(:,i,:);
    end
end
